...
!      fwuv = 0.0
   ...
   call read_char_input(500,'snapwave_fw',fwstr,'0.01')
   call read_char_input(500,'snapwave_fwig',fw_igstr,'0.015')
   ...
   call read_char_input(500,'snapwave_ncfile', gridfile,'sfincs.qtr')   
   !
   call read_char_input(500,'snapwave_neumannfile',neumannfile,'none') 
